...
'<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.':'<strong>insight</strong> все ще розробляється, тому не забудьте повідомити про будь-які помилки та надати відгук для покращення в нашому. <a href="https://github.com/Fair-Exchange/insight-ui-safecoin/issues" target="_blank">трекері помилок Github</a>.',
About:"Про провідник",
Address:"Адреса",
Age:"Вік",
"Application Status":"Статус Програми",
"Best Block":"Кращий Блок",
"Safecoin node information":"Інформація про ноду Safecoin",
Block:"Блок",
"Block Reward":"Винагорода Блоку",
Blocks:"Блоки",
"Bytes Serialized":"Серіалізовані Байти",
"Can't connect to safecoind to get live updates from the p2p network. (Tried connecting to safecoind at {{host}}:{{port}} and failed.)":"Неможливо підключитися до safecoind, щоб отримувати оновлення в реальному часі з мережі p2p. (Спроба підключення до безпечної адреси {{host}}:{{port}} не вдалося.)",
...
'<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.':'<strong>insight</strong> все еще разрабатывается, поэтому не забудьте сообщать о любых найденных ошибках в нашем <a href="https://github.com/Fair-Exchange/insight-ui-safecoin/issues" target="_blank">трекере ошибок Github</a>.',
About:"О проводнике",
Address:"Адрес",
Age:"Возраст",
"Application Status":"Статус программы",
"Best Block":"Лучший Блок",
"Safecoin node information":"Информация об ноде Safecoin",
Block:"Блок",
"Block Reward":"Вознаграждение за блок",
Blocks:"Блоки",
"Bytes Serialized":"сериализованные Байты",
"Can't connect to safecoind to get live updates from the p2p network. (Tried connecting to safecoind at {{host}}:{{port}} and failed.)":"Невозможно подключиться к safecoind, чтобы получать обновления в реальном времени из сети p2p. (Попытка подключения к safecoind по адресу {{host}}:{{port}} не удалась.)",
