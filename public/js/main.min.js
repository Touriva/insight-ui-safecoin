...
gettextCatalog.setStrings("ua",{"(Input unconfirmed)":"(Вхід не підтверджено)","404 Page not found :(":"404 Сторінка відсутня :(",'<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source Safecoin blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by safecoind RPC.  Check out the <a href="https://github.com/Fair-Exchange/insight-ui-safecoin" target="_blank">source code</a>.":"<strong>insight</strong>  це <a href="http://live.insight.is/" target="_blank">провідник блокчейну Safecoin з відкритим початковим кодом</a> із повним набором REST та API веб-сторінок, які можна використовувати для написання веб-гаманців та інших додатків, для якіпотребують більш складних запитів до блокчейну, крім випадків, передбачених Safecoind RPC.  Перевірте початковий код <a href="http://github.com/bitpay/insight" target="_blank">в репозиторії Github</a>.','<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.":"<strong>insight</strong> все ще розробляється, тому не забудьте повідомити про будь-які помилки та надати відгук для покращення в нашому. <a href="https://github.com/Fair-Exchange/insight-ui-safecoin/issues" target="_blank">трекері помилок Github</a>.',About:"Про провідник",Address:"Адреса",Age:"Вік","Application Status":"Статус Програми","Best Block":"Кращий Блок","Safecoin node information":"Ынформацыя про вузол Safecoin",Block:"Блок","Block Reward":"Винагорода Блоку",Blocks:"Блоки","Bytes Serialized":"Серіалізовані Байти","Can't connect to safecoind to get live updates from the p2p network. (Tried connecting to safecoind at {{host}}:{{port}} and failed.)":"Неможливо підключитися до safecoind, щоб отримувати оновлення в реальному часі з мережі p2p. (Спроба підключення до безпечної адреси {{host}}:{{port}} не вдалося.)","Can't connect to insight server. Attempting to reconnect...":"Неможливо підключитися до серверу insight. Спроба повторного підключення...","Can't connect to internet. Please, check your connection.":"Неможливо підключитися до Інтернету. Будь ласка, перевірте ваше з'єднання.",Complete:"Завершено",Confirmations:"Підтвердження",Conn:"З'єдн.","Connections to other nodes":"З'єднання з іншими вузлами","Current Blockchain Tip (insight)":"Фактичний Статус Блокчейну (insight)","Current Sync Status":"Поточний Статус Синхронізації",Details:"Подробиці",Difficulty:"Складність","Double spent attempt detected. From tx:":"Виявлено спробу подвійної витрати. З транзакції:","Error!":"Помилка!",Fee:"Комісія","Final Balance":"Остаточний Баланс","Finish Date":"Дата Закінчення","Go to home":"Повернутися на головну","Hash Serialized":"Серіалізований Хеш",Height:"Висота","Included in Block":"Включено в Блок","Incoherence in levelDB detected:":"Виявлено незрівняність в levelDB:","Info Errors":"Інформація про Помилки","Initial Block Chain Height":"Початкова Висота Блокчейну",Input:"Вхід","Last Block":"Останній Блок","Last Block Hash (Safecoind)":"Останній Хеш Блоку (Safecoind)","Latest Blocks":"Останні Блоки","Latest Transactions":"Останні Транзакції","Loading Address Information":"Завантаження Інформації про Адресу","Loading Block Information":"Завантаження Інформації про Блок","Loading Selected Date...":"Завантаження Обраної Дати...","Loading Transaction Details":"Завантаження Подробиць Транзакції","Loading Transactions...":"Завантаження Транзакцій...","Loading...":"Завантаження...","Mined Time":"Час Видобутку","Mined by":"Видобутий","Mining Difficulty":"Складність Видобутку","Next Block":"Наступний Блок","No Inputs (Newly Generated Coins)":"Немає Входів (Новостворені Монети)","No blocks yet.":"Ще немає блоків.","No matching records found!":"Не знайдено відповідних записів!","No. Transactions":"Транзакції Відсутні","Number Of Transactions":"Кількість Транзакцій",Output:"Вихідні дані","Powered by":"Працює завдяки","Previous Block":"Попередній Блок","Protocol version":"Версія протоколу","Proxy setting":"Налаштування проксі","Received Time":"Отриманий Час","Redirecting...":"Перенаправлення...","Search for block, transaction or address":"Пошук блоку, транзакції або адреси","See all blocks":"Переглянути всі блоки","Show Transaction Output data":"Показати дані про вихід транзакції","Show all":"Показати все","Show input":"Показати введення","Show less":"Показати менше","Show more":"Показати більше",Size:"Розмір","Size (bytes)":"Розмір (байтів)","Skipped Blocks (previously synced)":"Пропущені блоки (попередньо синхронізовані)","Start Date":"Дата Початку",Status:"Статус",Summary:"Підсумок","Summary <small>confirmed</small>":"Підсумок <small>підтверджено</small>","Sync Progress":"Прогрес Синхронізації","Sync Status":"Статус Синхронізації","Sync Type":"Тип Синхронізації","Synced Blocks":"Синхронізовані Блоки",Testnet:"Тестова мережа","There are no transactions involving this address.":"Немає транзакцій із цією адресою.","Time Offset":"Час Зсуву",Timestamp:"Дата та Час",Today:"Сьогодні","Total Amount":"Загальна Сума","Total Received":"Усього Стримано","Total Sent":"Усього Надіслано",Transaction:"Транзакція","Transaction Output Set Information":"Інформація про вихідні транзакції","Transaction Outputs":"Виходи Транзакції",Transactions:"Транзакції",Type:"Тип",Unconfirmed:"Не підтверджено","Unconfirmed Transaction!":"¡Непідтверджена Транзакція!","Unconfirmed Txs Balance":"Баланс без Підтвердження","Value Out":"Вихідне Значення",Version:"Версія","Waiting for blocks...":"Очікуємо блоки...","Waiting for transactions...":"Очікуємо транзакції...","by date.":"за датою.","first seen at":"Видно до",mined:"видобутий","mined on:":"видобутий на:","Waiting for blocks":"Очікуємо блоки"}),
gettextCatalog.setStrings("ru",{"(Input unconfirmed)":"(Вход не подтверждён)","404 Page not found :(":"404 Страница не найдена :(",'<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source Safecoin blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by safecoind RPC.  Check out the <a href="https://github.com/Fair-Exchange/insight-ui-safecoin" target="_blank">source code</a>.":"<strong>insight</strong>  это <a href="http://live.insight.is/" target="_blank">проводник блокчейна Safecoin с открытым исходным кодом</a> с полным набором REST и API, которые можно использовать для написания приложений, требующих более сложные запросы к блокчейну, за исключением RPC Safecoind. Проверьте исходный код <a href="http://github.com/bitpay/insight" target="_blank">в репозитории Github</a>.','<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.":"<strong>insight</strong> все еще разрабатывается, поэтому не забудьте сообщать о любых найденных ошибках в нашем <a href="https://github.com/Fair-Exchange/insight-ui-safecoin/issues" target="_blank">трекере ошибок Github</a>.',About:"О проводнике",Address:"Адрес",Age:"Возраст","Application Status":"Статус программы","Best Block":"Лучший Блок","Safecoin node information":"Информация об ноде Safecoin",Block:"Блок","Block Reward":"Вознаграждение за блок",Blocks:"Блоки","Bytes Serialized":"сериализованные Байты","Can't connect to safecoind to get live updates from the p2p network. (Tried connecting to safecoind at {{host}}:{{port}} and failed.)":"Невозможно подключиться к safecoind, чтобы получать обновления в реальном времени из сети p2p. (Попытка подключения к safecoind по адресу {{host}}:{{port}} не удалась.)","Can't connect to insight server. Attempting to reconnect...":"Невозможно подключиться к серверу insight. Попытка повторного подключения...","Can't connect to internet. Please, check your connection.":"Невозможно подключиться к Интернету. Пожалуйста, проверьте ваше соединение.",Complete:"Завершено",Confirmations:"Подтверждения",Conn:"Подкл","Connections to other nodes":"Соединения с другими узлами","Current Blockchain Tip (insight)":"Фактический Статус Блокчейна (insight)","Current Sync Status":"Текущий статус синхронизации",Details:"подробности",Difficulty:"Сложность","Double spent attempt detected. From tx:":"Обнаружена попытка двойной траты. С транзакции:","Error!":"Ошибка!",Fee:"Комиссия","Final Balance":"Остаточный баланс","Finish Date":"Последняя дата","Go to home":"Вернуться на главную","Hash Serialized":"Сериализованный Хеш",Height:"Высота","Included in Block":"Включено в Блок","Incoherence in levelDB detected:":"В LevelDB обнаружена несогласованность:","Info Errors":"Информация об ошибках","Initial Block Chain Height":"Начальная Высота Блокчейна",Input:"Вход","Last Block":"Последний Блок","Last Block Hash (Safecoind)":"Последний Хеш Блока (Safecoind)","Latest Blocks":"Последние блоки","Latest Transactions":"Последние транзакции","Loading Address Information":"Загрузка Информация об адресе","Loading Block Information":"Загрузка Информации о Блоке","Loading Selected Date...":"Загрузка выбранной даты...","Loading Transaction Details":"Загрузка Подробностей Транзакции","Loading Transactions...":"Загрузка Транзакции...","Loading...":"Загрузка...","Mined Time":"Время Добычи","Mined by":"Кто Добыл","Mining Difficulty":"Сложность Добычи","Next Block":"Следующий Блок","No Inputs (Newly Generated Coins)":"Нет входов (Новые сгенерированные монеты)","No blocks yet.":"Пока блоков нет.","No matching records found!":"Сожалеем, не нашлось ничего похожего!","No. Transactions":"Нет транзакций","Number Of Transactions":"Количество транзакций",Output:"Выходы","Powered by":"Работает благодаря","Previous Block":"Предыдущий Блок","Protocol version":"Версия протокола","Proxy setting":"Настройки Proxy","Received Time":"Время получения","Redirecting...":"Перенаправление...","Search for block, transaction or address":"Поиск блока, транзакции или адреса","See all blocks":"Посмотреть все блоки","Show Transaction Output data":"Показать данные о выходе транзакции","Show all":"Показать всё","Show input":"Показать входы","Show less":"Показать меньше","Show more":"Показать больше",Size:"Размер","Size (bytes)":"Размер (байты)","Skipped Blocks (previously synced)":"Пропущенные блоки (предварительно синхронизированы)","Start Date":"Дата Начала",Status:"Статус",Summary:"Итого","Summary <small>confirmed</small>":"Итого <small>подтверждено</small>","Sync Progress":"Прогресс Синхронизации","Sync Status":"Статус Синхронизации","Sync Type":"Тип Синхронизации","Synced Blocks":"Синхронизованные Блоки",Testnet:"Тестовая сеть","There are no transactions involving this address.":"Нет транзакций с этим адресом","Time Offset":"время Смещения",Timestamp:"Временная метка",Today:"Сегодня","Total Amount":"Общая сумма","Total Received":"Всего получено","Total Sent":"Всего отправлено",Transaction:"Транзакция","Transaction Output Set Information":"Информация о выходных транзакциях","Transaction Outputs":"Выходы Транзакций",Transactions:"Транзакции",Type:"Тип",Unconfirmed:"Не подтверждено","Unconfirmed Transaction!":"Неподтвержденная Транзакция!","Unconfirmed Txs Balance":"Неподтвержденный Баланс","Value Out":"Выход",Version:"Версия","Waiting for blocks...":"Ожидаем блоки...","Waiting for transactions...":"Ожидаем транзакции...","by date.":"за дату.","first seen at":"Первый раз видели",mined:"добытый","mined on:":"кем добытый:","Waiting for blocks":"Ожидаем блоки"})}]); 
>>>>>>> d7147f51a9ec9496f9869556466085e1f2e016b6
